...
void mycontrol (int f[LEN][LEN]){
	...
	while (1){
		...
		if(f[y][x] == HU) {
			...
			printw("移動させたいx座標を選べ");
			scanw("%d",&i);
			if(y-w == 1 && x-i ==0 && f[w][i] == 0)f[y-1][x] = OU;
			
			else if(y-w == 1 && x-i == 1 && f[w][i] == 0) f[y-1][x-1] = OU;
		
			else if(y-w == 1 && x-i == -1&& f[w][i] == 0) f[y-1][x+1] = OU;
			
			else if(y-w == 0 && x-i == -1 && f[w][i] == 0) f[y][x+1] = OU;
			...
			else if (y-w == -1 && x-i == 0 && f[w][i] == 0) f[y+1][x] = OU;
			...
			printw("移動させたいx座標を選べ");
			scanw("%d",&i);
			if (y-w == 1 && x-i == 0 && f[w][i] == 0) f[y-1][x] = GIN;

			else if(y-w == 1 && x-i == 1 && f[w][i] == 0) f[y-1][x-1] = GIN;
			...
			else if (y-w == 1 && x-i == 0 && f[w][i] == 0) f[y-1][x] = KIN;
			...
			else if (y-x == 1 && x-i == 0 && f[w][i] == 0) f[w][i] = KIN;
